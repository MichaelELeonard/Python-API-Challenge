...
## The city dataset was filtered to identify locations with ideal weather conditions:
...
## The vacation destinations were added to a map with the hotel name and country of origin as a popup hover message.
